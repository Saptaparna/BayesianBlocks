...
int makeLimitTemplates_ZeroValue(std::string infile, std::string outfile, double kfactor){
  ...
  for (int i=0; i<nEvents; ++i)
    {
      ...
      if(ST_mul7 > 2600){
        ...
        for(int j=1; j<binmul7+1; j++) {
          ...
          h_ST_mul7->SetBinContent(binmul7, 0.0);
        }
      }
      ...
      if(ST_mul8 > 2800){
        ...
        for(int j=1; j<binmul8+1; j++) {
          ...
          h_ST_mul8->SetBinContent(binmul8, 0.0);
        }
      }
      ...
      if(ST_mul9 > 2800){
        ...
        for(int j=1; j<binmul9+1; j++) {
          ...
          h_ST_mul9->SetBinContent(binmul9, 0.0);
        }
      }
      ...
      if(ST_mul10 > 2900){
        ...
        for(int j=1; j<binmul10+1; j++) {
          ...
          h_ST_mul10->SetBinContent(binmul10, 0.0);
        }
      }
