...
int makeLimitTemplates_Jun16(std::string infile, std::string outfile, double kfactor){
  ...
  Float_t rebin_array_Mul8[] = {2500.08846146,  2576.27436273,  2939.39938432,  3055.26466121, 3803.36199668,  7206.79109709, 20000.0};
