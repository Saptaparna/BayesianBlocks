...
int makeLimitTemplates(std::string infile, std::string outfile, double kfactor){
  ...
  for (int i=0; i<nEvents; ++i)
   ...
   h_ST_mul8_BB->Draw();
   Double_t par[6];
   TF1 *fa1 = new TF1("fa1", "gaus", 2500, 7000);
   TF1 *fa2 = new TF1("fa2", "gaus", 7000, 20000);
   ...
   outFileBB=new TFile("SignalBB_ToySignal/BH_Tree_BH1_BM_MD4000_MBH9000_n6.root", "RECREATE");
