...
void DrawLimitPlot_BB_Mul10()
{
  ...
  for (unsigned int i_mass=0; i_mass<mass.size(); ++i_mass)
  {
    ...
    std::string filename="BayesianBlocks_BH_Mul10_MBH_"+mass_string+"GeV.log";
...
//    getline(file, line);
  ...
  leg->Draw();
  c_xsec->SetLogy(); 
  c_xsec->SaveAs("c_xsec_BB_Mul10.png");
  c_xsec->SaveAs("c_xsec_BB_Mul10.pdf");
