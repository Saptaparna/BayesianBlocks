...
void DrawLimitPlot_BB()
{
  ...
  for (unsigned int i_mass=0; i_mass<mass.size(); ++i_mass)
  {
    ...
    std::string filename="DataCard_BlackMaxLHArecord_BH1_BM_MD4000_MBH"+mass_string+"_n6.log";
...
//    getline(file, line);
  ...
  leg->Draw();
  c_xsec->SetLogy(); 
  c_xsec->SaveAs("c_xsec_BB.png");
  c_xsec->SaveAs("c_xsec_BB.pdf");
